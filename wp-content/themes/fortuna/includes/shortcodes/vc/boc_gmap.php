...
vc_map( array(
		...
		"params"				=> array(
			...
			array(
				"type"			=> "textfield",
				"admin_label"	=> false,
				"heading"		=> __( "Google API Key", 'Fortuna' ),
				"param_name"	=> "api_key",
				"value"			=> "",
				"description"	=> __( "Enter your <a href='https://developers.google.com/maps/documentation/javascript/get-api-key' target='_blank'>Google API key</a>", 'Fortuna' ),
			),			
			array(
				"type"			=> "textfield",
				"admin_label"	=> false,
