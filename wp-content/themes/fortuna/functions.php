...
// Set Dependency var for styles
$boc_styles_dependency = array();
...
if(function_exists('vc_set_as_theme')){
	...
	// Set Dependency var for styles
	$boc_styles_dependency = array('js_composer_front');
}
...
function boc_styles() {
	...
	// Load Main CSS
	wp_enqueue_style( 'boc-main-styles', get_bloginfo( 'stylesheet_url' ), $boc_styles_dependency );

	// Animations CSS - with a dependency, load it after VC Css to overwrite the animations
	wp_enqueue_style( 'boc-animation-styles', get_template_directory_uri().'/stylesheets/animations.css', $boc_styles_dependency);
...
function boc_styles_rtl() {
	...
	// Animations CSS - with a dependency, load it after VC Css to overwrite the animations
	wp_enqueue_style( 'boc-animation-styles', get_template_directory_uri().'/stylesheets/rtl-animations.css', $boc_styles_dependency);
...
function boc_scripts() {
	...
	// Smooth Scrolling
	if(ot_get_option('smooth_scrolling','off') == 'on'){
