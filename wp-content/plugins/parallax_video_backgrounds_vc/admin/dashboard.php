...
if(isset($_POST['pnvb-submit'])) {
	...
	if(isset($_POST['uvc-theme-support'])) {
		$temp_result = esc_attr( $_POST['uvc-theme-support'] );
	}
	...
	if(isset($_POST['uvc-video-fixer'])) {
		$temp_result = esc_attr( $_POST['uvc-video-fixer'] );
	}
	...
	if(isset($_POST['uvc-smooth-scroll'])) {
		$temp_result = esc_attr( $_POST['uvc-smooth-scroll'] );
	}
	...
	if(isset($_POST['ultimate_smooth_scroll_options'])) {
		$temp_result = array_map( 'esc_attr', $_POST['ultimate_smooth_scroll_options'] );
	}
	...
	if(isset($_POST['uvc-smooth-scroll-compatible'])) {
		$temp_result = esc_attr( $_POST['uvc-smooth-scroll-compatible'] );
	}
