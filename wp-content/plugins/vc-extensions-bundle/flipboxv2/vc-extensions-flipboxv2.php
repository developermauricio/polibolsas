...
if (!class_exists('VC_Extensions_FlipBoxV2')){
    class VC_Extensions_FlipBoxV2{
      ...
      function cq_vc_flipboxv2_func($atts, $content=null) {
        ...
        if($headerwidth!=""){
            if(function_exists('wpb_resize')){
                $header_image_temp = wpb_resize($header_full_image, null, $headerwidth, null);
      ...
      function cq_vc_flipboxv2_item_func($atts, $content=null, $tag) {
          ...
          if($itemlink["url"]!=="") $output .= '<a href="'.$itemlink["url"].'" title="'.$itemlink["title"].'" target="'.$itemlink["target"].'" rel="'.$itemlink["rel"].'" class="cq-flipboxv2-itemlink">';
